...
export class AnalyticsController {
  ...
  @ApiResponse({
    status: 200,
    description: "Project savings retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "File savings retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Rule savings retrieved successfully",
  })
  ...
  async getSavingsTimeSeries(
    ...
    return this.analyticsService.getSavingsTimeSeries(
      projectId,
      start,
      end,
      granularity,
  ...
  @ApiResponse({
    status: 200,
    description: "Severity savings retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Top optimizations retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 201,
    description: "Gas savings recorded successfully",
  })
